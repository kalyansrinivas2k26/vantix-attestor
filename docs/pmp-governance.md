...
| Governance | Six release gates, decision register and evidence index | `docs/final-signoff-gates.md`, `docs/decision-register.md` | Documented; Portfolio Preview gates closed except demo presentation artifact |
...
| Decision authority | Deterministic policy precedes AI narrative; allowed approver roles are explicit | Workflow JSONs, `CA-N02`, `CM-N02`, `SEC-01`, `SEC-02` | Demonstrated for synthetic governed paths |
...
| Responsible AI | Bounded AI, output validation and executed security regression | `docs/security-threat-model.md`, `SEC-01` through `SEC-04` | Demonstrated for the synthetic Portfolio Preview suite |
