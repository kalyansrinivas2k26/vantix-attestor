...
## Consolidated adversarial regression — executed synthetic suite

| IDs | Area |
| --- | --- |
| `CA-N01`–`CA-N04` | commitment assurance fail-closed conditions |
| `SR-N01`–`SR-N04` | service recovery negative paths |
| `CM-N01`–`CM-N03` | customer momentum negative paths |
| `SEC-01`–`SEC-04` | OWASP-aligned AI/security controls |
| `XMOD-01`–`XMOD-03` | cross-module isolation |

Owner-run result: **18/18 PASSED**. See `evidence/reports/adversarial-regression-v0.1.html`.
